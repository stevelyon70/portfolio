...
$(function () {
    ...
    serviceUrl: '../../../../cfc/contractor_profile.cfc?method=getContractorRowBased3',
  
    transformResult: function(response){
		return {
			suggestions: $.map(response.rows, function(dataItem){
				return {
					value: dataItem.contractor,
					data: dataItem.supplierid
				};
			})
		};
	},
	onSelect: function(suggestion) {
            $('#selction-remote').html('You selected: ' + suggestion.value + ', ' + suggestion.data);
        }
});
