...
<cfif TotalRows GT RowsPerPage>
	...
	<cfloop from="1" to="#TotalRows#" Step="#RowsPerPage#" index="PageRow">
		...
		<cfelse>
			<cfset ThisHRef = "#cgi.script_name#?StartRow=#PageRow#&rowsperpage=#rowsperpage#" & "#tempHRef#">
			<a href="javascript:redirect('#ThisHRef#')"><font color="blue" size="1"><u>#ThisPage#</u></font></a>
		</cfif>
	...
	<!--- Show All Link --->
	<cfset ThisHRef = "#cgi.script_name#?ShowAll=Yes" & "#tempHRef#">
	<a href="javascript:redirect('#ThisHRef#')"><font color="blue" size="1"><u>Show All</u></font></a>
</cfif>
