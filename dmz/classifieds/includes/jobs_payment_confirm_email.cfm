...
<cfmail
	subject="A Job Posting Has Been Purchased via Authorize.net"
...
The following transaction for a <strong>Job Posting</strong> has been processed via Authorize.net.<br>
<hr>
...
Listed under: #get_item.displaycompany#<br>
Job ID: <a href="http://cms.technologypub.com/internaluseonly/cms/careercenter/edit.cfm?jobID=#jobID#">#jobID#</a>
<br><br>
</font>		
</cfmail>
<cfelse>
<cfmail
	subject="A Job Posting Has Been Made by a Free Poster"
	from="webmaster@paintsquare.com"			
	...
	type="html">
<font face="Arial, Helvetica, sans-serif" size="2" >	
The following transaction for a <strong>Job Posting</strong> has been processed.<br>
<hr>
Datestamp: #dateformat (date, 'dddd, mmmm d, yyyy')# #timeformat (date, 'h:mm TT')#<br>
<hr>
Headline: #get_item.positiontitle#<br>
