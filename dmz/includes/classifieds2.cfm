			...
			<cfloop query="getjobs" startrow="1" endrow="#short_max#">
				...
				<cfset newpositiontitle = #ucase(last1)# & #lcase(last2)#>						
						<cfif featjobs.recordcount is 1>
							...
							<i class="clip-note"></i>						
							<a href="../../classifieds/?fuseaction=jobs&action=view&jobID=#getjobs.jobID#&featjob=1">#newpositiontitle#</a>
						<cfelseif getjobs.supplierID is not "" and feature.recordcount gt 0>
							...
							<i class="clip-note"></i>
							<a  href="../../classifieds/?fuseaction=jobs&action=view&jobID=#getjobs.jobID#&feature=1">#newpositiontitle#</a>
						<cfelse>
							<i class="clip-note"></i>
							<a href="../dmz/?action=classifieds&fuseaction=jobs&action=view&jobID=#getjobs.jobID#">#newpositiontitle#</a>
