							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="table-responsive">
								         <table class="table table-striped table-bordered table-hover table-full-width" id="contractorT">
											<thead>
												<tr>
											...
											<tbody>
												<cfloop query="top_contractor_query" >
													...
													<cfoutput>
														<cfset variables.activity = top_contractor_query.numberofprojects*100/sumprojects.totalproj>
												<tr>
													...
													<td>#round(variables.activity)#%</td>
													<td>#dollarformat(top_contractor_query.total_spending)#</td>
												</tr>
												   </cfoutput>
												</cfloop>
