...
<!---cfparam name="agencylist" default="">	
	<cfif isdefined("agency_name") and agency_name NEQ "">
		<cfsearch name="agency_results" collection="contrak_engineer_search" criteria="#agency_name#">
...
<cfinvoke  
		...
		method="pull_engineer_results"  
		returnVariable="getEngineerResults"> 
				<cfif isdefined("engineerID")>
				<cfinvokeargument name="engineerID" value="#supplierID#"/> 
				</cfif>
	...
	<cfoutput>
		...
		<input type="hidden" name="specification_field" value="<cfif isdefined("form.specification_field")>#form.specification_field#</cfif>">
	</cfoutput>
						...
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									Architect/Engineer Search Results
