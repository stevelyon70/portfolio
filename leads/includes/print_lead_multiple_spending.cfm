<!---********************************
	PRINT MULTIPLE LEADS PDF - SPENDING
	CREATED BY RM 02/08/2018
*************************************--->

<cfsetting showdebugoutput="false">
<cfset valid = true>
<cfparam default="0" name="form.bidids" />
<cfparam default="0" name="form.userid" />
<cfparam default="50" name="site_tagID" />

<cfset pdf_folder_path = "..\pdf_files\leads_#form.userid#.pdf">

<cfset form.bidids = #Replace(form.bidids," ","","ALL")#>

<cfloop list="#form.bidids#" index="b"> 
	...
	<cfif NOT valid><cfbreak></cfif>
</cfloop>	 


<cfif valid>
	<cfhtmltopdf margintop=".5" marginbottom=".5"  marginleft=".5" marginright=".5" destination="#expandpath(pdf_folder_path)#" overwrite="true">
	<cfhtmltopdfitem type="header">Paint BidTracker Lead Details</cfhtmltopdfitem>
	<cfloop list="#form.bidids#" index="bp"> 
	<cfoutput>#evaluate("leadDetail_" & bp)#</cfoutput>
