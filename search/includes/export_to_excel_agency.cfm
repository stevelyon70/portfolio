...
<cfinclude template="search_results_excel_format_agency.cfm">
</cfsilent>
<!--- Create new spreadsheet --->
       <cfset ProjectDir = spreadsheetNew()>
       <cfset project_file = #GetTempFile(GetTempDirectory(),"testFile")#>
        <!--- Create header row --->		   
        <cfset SpreadsheetAddRow(ProjectDir, "BidID, Project Name, Stage, Agency, City, State, Relevant Tags, Start Year, End Year, Budget")>
