...
<cfif IsDefined("BD")><cfset temphref = temphref & "&BD=#BD#"></cfif>	
      <table border="0" cellpadding="0" width="410" >
        <tr bgcolor="white">
          <td width="400"  valign="top"><a href="##bid"><u><span class="tex2">#getbids_count.recordcount# Bid Notices</span></u></a>
		
		  </td>
        </tr>
		 <cfform name="CFForm_1" action="?userid=#session.auth.userid#&supplierID=#supplierID#&bid=1&prs=1&bd=1&action=#action#" method="POST">
        <tr bgcolor="white">
          <td width="400"  valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="tex">View All Bid Notices for this Company Posted between</span><br>
		   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   <label for="bidfrom">From</label>
		   <input type="text" id="bidfrom" name="bidfrom"/>
		   <label for="bidto">to</label>
		   <input type="text" id="bidto" name="bidto"/>&nbsp;<input type="submit" name="submit" value="Go"> </td>
        </tr>
		</cfform>
		<cfset tempHRef1 = "">
...
<cfif IsDefined("awd")><cfset temphref1 = temphref1 & "&awd=#awd#"></cfif>
 <cfif IsDefined("ad")><cfset temphref1 = temphref1 & "&ad=#ad#"></cfif>
        <tr bgcolor="white">
         ...
         <tr bgcolor="white">
          <td width="400"  valign="top"><a href="##bid"><u><span class="tex2">#getawards.recordcount# Awards/Results In Last 60 Days</span></u></a>
		
		  </td>
        </tr>
		 <cfform name="CFForm_1" action="?userid=#session.auth.userid#&supplierid=#supplierid#&awd=1&prs=2&ad=1&action=#action#" method="POST">
        <tr bgcolor="white">
          <td width="400"  valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="tex">View All Awards/Results Notices for this Company Posted between</span><br>
		   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <label for="awardfrom">From</label>
		   <input type="text" id="awardfrom" name="awardfrom"/>
		   <label for="awardto">to</label>
		   <input type="text" id="awardto" name="awardto"/>&nbsp;<input type="submit" name="submit" value="Go"></td>
        </tr>
		</cfform>
	 ...
	 <span class="tex"><strong>Contact Information</strong></span><br>
	  <cfif emailaddress is not "">
		...
		<cfif billingaddress is not "">
          ...
          <span class="tex">Address: #billingaddress#</span>
        <br>
		</cfif>
		<cfif city is not "">
