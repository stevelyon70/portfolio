					  ...
					  <th class="grid grid_head searchGridHead col-xs-1 text-center">
					  	<cfif search_results.recordcount GT 0>
					  		...
					  		<select class="actionSelect">
								...
								<cfif #session.auth.userid# eq 15210><option value="_5">Print Leads</option></cfif>
					  		</select>
					  	</cfif>
						 <!---<cfif search_results.recordcount GT 0>
				...
				<tr class="grid projectBid tags-row">
					...
					<cfquery name="get_tags" datasource="#application.datasource#">
						...
						<cfif not listfind(url.tags,get_tags.tagID[f])>
							<a href="?search_history=1&action=sresults&state=66&project_stage=1&project_stage=2&project_stage=3&project_stage=4&projecttype=1&tags=#get_tags.tagID[f]#"><span class="tags pull-left">#get_tags.tag[f]#</span></a>
						<cfelse>
							<span class="tags pull-left">#get_tags.tag[f]#</span>
						</cfif>
						</cfloop>
						...
						<cfif not listfind(url.tags,get_tags.tagID[s])>
							<a href="?search_history=1&action=sresults&state=66&project_stage=1&project_stage=2&project_stage=3&project_stage=4&projecttype=1&tags=#get_tags.tagID[s]#"><span class="tags pull-left">#get_tags.tag[s]#</span></a>
						<cfelse>
							<span class="tags pull-left">#get_tags.tag[s]#</span>
						</cfif>
						</cfloop>
						</span>
						<span class="tagstwo pull-left js-more js-more-#bidid#" data-bidid="#bidid#">show #get_tags.recordcount-5# more</span>
						</cfif>
		...
		<div class="modal-body">
			<form NAME="tracklead" id="tracklead">
				...
				<table width="100%">
					...
					<tr>
						<td align="center">
							<input name="savelead" id="savelead" type="button" value="Save" style="background-color:#ffc303;" class="btn btn-default">
							&nbsp;
	  ...
	  <div class="modal-content">
		...
		<div class="modal-body">
			<form NAME="printlead" id="printlead">
				<input type="hidden" value="<cfoutput>#session.auth.userid#</cfoutput>" name="userid" id="userid">
				<input type="hidden" name="bidid" id="printbidid" value="">
				<table width="100%">
					<tr>
						<td align="center">
					...
					<tr>
						<td align="center">
							<input name="print" id="printp" type="button" value="Create" class="btn btn-primary">
							<div class="js-message" style="color: red;"></div>
						</td>
					</tr>
				</table>			
