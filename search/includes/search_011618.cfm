...
<div class="col-md-12 pull-left">
	...
	<div class="col-md-6 col-xs-12 pull-left">
		...
		<div class="sectionBody">
			...
			<div class="form-row">
				<div class="col"><label for="structures">Search operator:</label>
					<div class="col-sm-2"><cfinput name="filter" type="radio" value="and" checked> And</div>
					<div class="col-sm-2"><cfinput name="filter" type="radio" value="or" > Or</div>
