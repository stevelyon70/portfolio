...
(foldername,active,datecreated,userid,description,privacy_setting, siteid)
values('#form.foldername#',1,#date#,#form.userid#,'#form.description#',#share#, #form.siteid#)
</cfquery>
...
<cfelse>
	...
	<cfform action="#cgi.script.name#?action=60&process=21" method="POST" enablecab="Yes">
			  <cfinput type="hidden" name="siteid" value="#session.auth.siteID#">
