 <cfoutput>
  <cfloop from="1" to="#arraylen(arrQueryNames)#" index="_qInx">
    <cfloop query="#arrQueryNames[_qInx]#" >
		...
		and t.tagid not in(#session.default.tagId#)
		and t.active = 1
		</cfquery>
	...
	<cfset status_display2 = "">
	  ...
	  <cfif request.emailType is 'bids' and _qInx lt 2>									
      <cfswitch expression="#getstatus.updateid#">
      ...
      <tr>
        <td width="20%"><span style="font-size:10px; font-style:italic; font-weight:bold; color:##df002c; vertical-align:text-top;">
          ...
          BidID - #bidid#<br>
          <a href="http://www.paintsquare.com/newsletter/tracking/bid/index_wbt.cfm?nl_moduleid=41&nl_versionid=#nl_versionid#&redirectid=739&userid=#user1#&bidid=#bidid#&#addt_variables#" style="color:##2d53ac; text-decoration:none; font-weight:bold;">#projectname#</a></td>
		<cfif request.emailType is 'awards'>
