 <cfoutput>
		<table width="100%" cellpadding="5" cellspacing="0" border="0" bgcolor="##ffffff">
          		<tr>
                  	...
                  	<span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold; padding-bottom:7px; margin-bottom:7px;">Bid Notices and Awards & Results - Water BidTracker</span><span style="font-size:5px;"><br /><br /></span>
                  <span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;  font-style:italic; font-weight:bold; padding-bottom:7px; margin-bottom:7px;">Targeted Water and Wastewater Project Leads</span><span style="font-size:5px;"><br /><br /></span>
