...
<!---run tags check--->
	...
	<cfquery name="spending_query">	
				SELECT distinct a.bidID,a.projectname,a.owner,a.tags,a.city,
	 			a.state,a.stateID,a.stage,a.stageID,a.paintpublishdate,a.zipcode,a.county,bid_user_viewed_log.bidid as viewed,pbt_project_updates.updateid,a.project_startdate,a.project_enddate,a.total_budget,a.supplierID
