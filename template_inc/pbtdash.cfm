...
<div class="section">
	...
	<!---<div class="col col-sm-4 hidden-xs pull-left">
		<div class="well ">
			<h4>Notifications:</h4>
			<!---<p><i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Mar 29, 2018 - Paint BidTracker will be closed on Friday, March 30 in observance of the Easter holiday. Bid emails will resume on Monday, April 2nd.</p>--->
			<!---<p><i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> May 14, 2018 - Daily Email settings have been updated. <a href="/dmz/?action=webinars">Click here</a> to learn more. </p>--->
  ...
  <div class="col col-sm-6 col-xs-12 pull-left dashbox" id="box12">
    <div class="dashboxTitle">Quick Search <span class="pull-right">  <i class="fa fa-times-circle-o fa-lg dashClose" aria-hidden="true"></i> </span></div>
  ...
  <div class="col col-sm-4 col-xs-12 pull-left dashbox" id="box7">
    <div class="dashboxTitle">Leads and Bid Notices <span class="pull-right">  <i class="fa fa-times-circle-o fa-lg dashClose" aria-hidden="true"></i> </span></div>
  ...
  <div class="col col-sm-4 col-xs-12 pull-left dashbox" id="box8">
    <div class="dashboxTitle">Awards and Results <span class="pull-right">  <i class="fa fa-times-circle-o fa-lg dashClose" aria-hidden="true"></i></span></div>
			 ...
			 $( "path" ).each(function() {
				 if (typeof $( this ).attr('aria-label') != 'undefined'){
					 $(this).on('click', function(){
						 ...
						 location = '/search/?search_history=1&action=sresults&filter=and&state='+$stateID+'&amount=1&qt=&bidid=&contractorname=&postfrom=&postto=&subfrom=&subto=&SEARCH=SEARCH';
					 })					 
				 }
		     });
				$_init = false;
