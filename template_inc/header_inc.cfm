<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="">
		<div class="col-sm-8 banner-logo-home">
			...
			<img src="<cfoutput>#request.rootpath#</cfoutput>assets/images/PBT_Logo_WebHeader_Home_DoubleSize.png" alt="Paint BidTracker" border="0" class="img-responsive"> </a>
		</div>

		<div class="navbar-tools col-sm-4">
			<!--- TOP NAV INCLUDE --->
			<cfif isdefined("session.auth.username") and session.auth.username NEQ "" and isUserLoggedIn() >
			<ul class="nav navbar-right hidden-sm hidden-xs" style="padding-top: 8px;">	
				<li class="dropdown notifications">
					<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
						<!---<i class="clip-list-5"></i>--->
						<i class="fa fa-exclamation-triangle headcss" aria-hidden="true"></i>
						
							<span class="badge"> <span class="noteCount">2</span></span>
							...
							<ul class="dropdown-menu todo">								
								...
								<li>
									<div class="drop-down-wrapper ps-container">
										<ul>
											<!---<li>											
												<i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Mar 29, 2018 - Paint BidTracker will be closed on Friday, March 30 in observance of the Easter holiday. Bid emails will resume on Monday, April 2nd. 
											</li>--->
											<li>											
												<i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> May 14, 2018 - Daily Email settings have been updated. <a href="/dmz/?action=webinars">Click here</a> to learn more.
											</li>
											<li>											
												<i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Mar 2, 2018 - Users experiencing scrolling issues in Internet Explorer: please download <a href="https://www.google.com/chrome/" target="_blank">Chrome</a> or <a href="https://www.mozilla.org/en-US/firefox/new/" target="_blank">Firefox</a> for optimal performance, or contact <a href="mailto:jlockley@paintbidtracker.com">Josiah Lockley</a> for assistance. 
											</li>
											<!---<li>											
												<i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Feb 23, 2018 - REMINDER: We will be officially switching to the new 360 platform on Saturday, February 24 and at that time you will no longer have access to the legacy site. Contact Josiah Lockley with questions or for training at jlockley@paintbidtracker.com, or visit our webinars and tutorials page <a href="http://beta360.paintbidtracker.com/dmz/?action=webinars">here</a>.
											</li>--->											
											<!---
											<li>											
											<i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Feb 9, 2018 - Join our Paint BidTracker 360 Webinar to learn about the new features, Friday, February 9th at 11 am EST. Click <a href="https://register.gotowebinar.com/register/946905299862089729" target="_blank">here</a> to register.
											</li>--->
											<!---<li>											
											<i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Feb 8, 2018  - Multiple lead printing is now available within the 'Multi Bid Action' drop down at the top of search results. Select up to 10 leads, choose 'Print Leads' from the drop down, then 'Create' the printable PDF. Once processed, click the 'PDF READY' button to view the PDF.
											</li>--->
											<!--li>											
											<i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Dec 22, 2017 - Searching by Coatings Type and Manufacturer have been added to the bid search form.
											</li-->
											<!--li>
											<i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Nov 28, 2017 - Looking at the map below, you can click on a state to run a search for that specific state.
											</li-->
...
<script>
		...
		$(function(){
			...
			// Quick View hover
			$(".qv").hover(function() {
				$(this).css('cursor','pointer').attr('title', 'Click for Quick View');
			});
			...
			$(".qv").click(function(){
			  ...
			  $(".qv-body").html("Content loading please wait...  <img src='../assets/images/spinner.svg'>");
			  $(".qv-title").html("QUICK VIEW - BidID: " + bidID);

			  $(".qv-footer").html(full);		
			  $("#quickview").modal("show");
			  $(".qv-body").load('../leads/includes/quickview.cfm?bidid=' + bidID);
			});	
