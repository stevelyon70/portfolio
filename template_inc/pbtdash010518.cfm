...
<div class="row">
  <div class="col col-sm-2 pull-left dashbox" id="box16">
    <div class="dashboxTitle">Ads</div>
	  <div class="dashboxContent dashText1"><!---cfinclude template="../search/includes/quicksearch.cfm" /---></div>
  </div>	
  <div class="col col-sm-5 pull-left dashbox" id="box13">
  ...
  <div class="col col-sm-5 pull-left dashbox" id="box12">
    <div class="dashboxTitle">Quick Search, Filter By <span class="pull-right">  <i class="fa fa-times-circle-o fa-lg dashClose" aria-hidden="true"></i> </span></div>
	  <div class="dashboxContent dashText1"><cfinclude template="../search/includes/quicksearch.cfm" /></div>
  </div>
</div>
<div class="row">
...
<div class="row">
  <div class="col col-sm-4 pull-left dashbox" id="box1">
...
<div class="row">
	<div class="col col-sm-12 pull-left dashbox" id="box14">
