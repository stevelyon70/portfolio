							...
							<ul class="dropdown-menu todo">								
								...
								<li>
									<div class="drop-down-wrapper ps-container">
										<ul>
											<li>											
											<i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Feb 20, 2018 - REMINDER: We will be officially switching to the new 360 platform on Saturday, February 24 and at that time you will no longer have access to the legacy site. Contact Josiah Lockley with questions or for training at jlockley@paintbidtracker.com
											</li>
											<!---<li>											
											<i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Feb 14, 2018 - Our offices will be closed on Monday, February 19, 2018 in observance of the Presidents' Day holiday.
											</li>
											<li>											
