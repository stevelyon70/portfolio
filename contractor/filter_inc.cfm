									...
									<div class="filter-main-title">
										Filters
											...
											<div class="btn-group" data-toggle="buttons">
											  ...
											  <label class="btn btn-default <cfif listfind(year_field,"2014")>active<cfelseif not listfind(year_field,"2015") and not listfind(year_field,"2016") and not listfind(year_field,"2017")>active</cfif>">
											  ...
											  <label class="btn btn-default <cfif listfind(year_field,"2017")>active</cfif>">
											    <input type="checkbox" name="year_field" autocomplete="off" value="2017" <cfif listfind(year_field,"2017")>checked</cfif>> 2017
											  </label>
											</div>
											</div>
