...
<!--- Retrieve all fields to be searched --->
		...
		select supplierID, contractor as CompanyName
		from contrak_contractor_search
		</cfquery>
		...
		<cfindex action="refresh"
		         collection="contrak_contractor_search"
		         key="supplierID"
		         type="custom"
		         title="companyname"
		         query="getresults"
...
<CFMAIL
			...
			type="html">
			Aborted the indexing for collection [contrak_contractor_search].
