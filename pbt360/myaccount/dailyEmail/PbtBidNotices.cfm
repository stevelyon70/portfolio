...
<!-- *************************** -->			
<cfset arrQueryNames = ["indInfUpd","comInfUpd","indPaintPrjBids","comPaintPrjBids","genConstMaintPrjBids","engDsgnBids","subContrOpp"]>
	
<cfset arrQueryNameLabels=	["Industrial Information Updates","Commercial Information Updates","Industrial Painting Project Bids","Commercial Painting Project Bids","General Construction Maintenance Project Bids","Engineering & Design Bids","Subcontracting Opportunities"]>
<cfinclude template="inc/db.cfm" />
	
<CFMAIL SUBJECT="Paint BidTracker Bid Notices for #dateformat(todaydate, "mmmm d, yyyy")#" FROM="daily_email@paintbidtracker.com" to="#emailaddress#"  type="html" bcc="slyon@technologypub.com">
