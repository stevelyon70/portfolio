...
<cfif not isdefined("projectid") or projectid is ""><cflocation url="?action=38&userid=#userid#&id_mag=#id_mag#"></cfif>
...
<cfquery name="getfolder" datasource="#the_dsn#">
...
<cflocation url="?userid=#userid#" addtoken="No">
			...
			<!---cfif getbids.recordcount is not 0>
				<cfquery name="querynew" datasource="#the_dsn#"><!---pull results from storedproc--->
...
<cfquery name="static" datasource="#the_dsn#">
...
ORDER BY bid_user_project_folders.foldername
       ...
       <cfoutput>
		 <span class="tex"><strong>My Folders - Current Folder: <font color="FF0000">#trim(getfolder.foldername)#</font></strong></span><br>
		 ...
		 <cfif getfolder.description is "" >
			...
			<a href="?action=58&userid=#userid#&id_mag=#id_mag#" 
		 ><span class="tex2">- add a description -</span></a>
			<cfelse>
			N/A
			</cfif>
		 
		 <cfelse>#trim(getfolder.description)#
		 
		 </cfif></span>
		 </cfoutput>	
		 <br><br><span class="tex">Here are the projects you are tracking in this folder. To view the details, click a project name. To move a project to a different folder, check the 'Select' box of the project, select the appropriate folder, and click the 'Move Project' button. To delete a project, check the 'Select' box and click the 'Delete Project' button.
		 <br><br>
		 To add a new project, use the left-hand menu to view or search for the information you want. On the project detail page, click the "Track Project" button and select this folder."
		 </span>
		  <CFFORM NAME="RFPManagement" ACTION="#cgi.script.name#?process=1&id_mag=#id_mag#" METHOD="post" onSubmit="return confirm('Are you sure?')">
	 <table width="100%" border="0">
		 
                  <TR id="ignore" bgcolor="white" border="0" align="right">
						<TD valign="bottom" colspan="9"> 
						 <!---cfselect name="project_folder" query="getfolders" value="folderid" display="foldername" style="font-size:14px;" required="yes" onChange="location=this.options[this.selectedIndex].value"><Option value="0" selected>- &nbsp;&nbsp;View a Different Folder&nbsp;&nbsp; -</OPTION></cfselect--->
					  
				<cfoutput> 	
				<CFSELECT   size="1" name="changefolder" onChange="location=this.options[this.selectedIndex].value">
				<CFLOOP Query="getfolders">
			   <OPTION value="?action=38&userid=#userid#&id_mag=#folderid#">#foldername#
				</CFLOOP>
...
</table><input type="hidden" value="#userid#" name="userid">
						<input type="hidden" value="#getbids.bidid#" name="bidid">
		</cfform> 
	
		<cfquery name="checkuser2" datasource="#the_dsn#">
select bid_subscription_log.packageid
from bid_subscription_log inner join bid_users on bid_users.userid = bid_subscription_log.userid 
where bid_users.userid =  #userid# and bid_subscription_log.effective_date <= #date# and bid_subscription_log.expiration_date >= #date#
</cfquery>  

		<table border="0"  bgcolor="black" bordercolor="black" bordercolorlight="black"   bordercolordark="black" width="100%" cellspacing="1" cellpadding="3" >

<tr id="ignore" bgcolor="white"   bordercolor="black" bordercolorlight="black"   bordercolordark="black"><cfoutput>

<td width="7%" bgcolor="666666" bordercolor="black"  bordercolorlight="black"   bordercolordark="black" align="center"><cfif isdefined("sort") and sort is 1 and desc is 2 ><a href="#cgi.script.name#?sort=1&desc=1&userID=#userID#&id_mag=#id_mag#&action=#action#"><cfelse><a href="#cgi.script.name#?sort=1&desc=2&userID=#userID#&id_mag=#id_mag#&action=#action#"></cfif><span class="tex4"><u><b>BidID</b></u></span></td>
<td width="15%" bgcolor="666666" align="center"><cfif isdefined("sort") and sort is 2 and desc is 2 ><a href="#cgi.script.name#?sort=2&desc=1&userID=#userID#&id_mag=#id_mag#&action=#action#"><cfelse><a href="#cgi.script.name#?sort=2&desc=2&userID=#userID#&id_mag=#id_mag#&action=#action#"></cfif><span class="tex4"><u><b>Project

Name</b></u></span></a></td>

<td width="12%" bgcolor="666666" align="center"><cfif isdefined("sort") and sort is 3 and desc is 2 ><a href="#cgi.script.name#?sort=3&desc=1&userID=#userID#&id_mag=#id_mag#&action=#action#"><cfelse><a href="#cgi.script.name#?sort=3&desc=2&userID=#userID#&id_mag=#id_mag#&action=#action#"></cfif><span class="tex4"><u><b>Agency</b></u></span></td>

<td width="10%" bgcolor="666666" align="center"><cfif isdefined("sort") and sort is 4 and desc is 2 ><a href="#cgi.script.name#?sort=4&desc=1&userID=#userID#&id_mag=#id_mag#&action=#action#"><cfelse><a href="#cgi.script.name#?sort=4&desc=2&userID=#userID#&id_mag=#id_mag#&action=#action#"></cfif><span class="tex4"><u><b>City</b></u></span></td>

<td width="5%" bgcolor="666666" align="center"><cfif isdefined("sort") and sort is 5 and desc is 2 ><a href="#cgi.script.name#?sort=5&desc=1&userID=#userID#&id_mag=#id_mag#&action=#action#"><cfelse><a href="#cgi.script.name#?sort=5&desc=2&userID=#userID#&id_mag=#id_mag#&action=#action#"></cfif><span class="tex4"><u><b>St.</b></u></span></td>

<td width="13%" bgcolor="666666" align="center"><cfif isdefined("sort") and sort is 6 and desc is 2 ><a href="#cgi.script.name#?sort=6&desc=1&userID=#userID#&id_mag=#id_mag#&action=#action#"><cfelse><a href="#cgi.script.name#?sort=6&desc=2&userID=#userID#&id_mag=#id_mag#&action=#action#"></cfif><span class="tex4"><u><b>Bid Submittal Date</b></u></span></td>
<td width="13%" bgcolor="666666" align="center"><cfif isdefined("sort") and sort is 7 and desc is 2 ><a href="#cgi.script.name#?sort=7&desc=1&userID=#userID#&id_mag=#id_mag#&action=#action#"><cfelse><a href="#cgi.script.name#?sort=7&desc=2&userID=#userID#&id_mag=#id_mag#&action=#action#"></cfif><span class="tex4"><u><b>Last Changed</b></u></span></td>
<td width="13%" bgcolor="666666" align="center"><span class="tex4"><b>Delete</b></span></td>
<td width="13%" bgcolor="666666" align="center"><span class="tex4"><b>Move</b></span></td>
</cfoutput>
</tr>
<cfif getbids.recordcount is not 0>
...
<!---cfquery name="getdate" datasource="#the_dsn#">select paintpublishdate from pbt_project_master_gateway where bidid = #bidid#</cfquery>
<cfquery name="getstatus" datasource="#the_dsn#" maxrows=1>select updateid from pbt_project_updates where bidid = #bidid#  order by uid desc</cfquery--->
...
<td width="15%" >
<!---cfquery name="checkstatus" datasource="#the_dsn#">select bidid,postdate from bid_award where bidid = #bidid#</cfquery--->


<!---cfquery name="getstatus" datasource="#the_dsn#" maxrows=1 cachedwithin="#CreateTimeSpan(0,0,30,0)#">select updateid,datemodified as moddate from pbt_project_updates where bidid = #bidid# and datemodified >= (select max(date_viewed) from bid_user_project_view_log where userid =#userid#) order by uid desc</cfquery--->
...
<cfif stageID NEQ "26">
      <a href="../leads/?bidid=#bidid#&userid=#userid#">
  <cfelse>
 	  <a href="../leads/?action=planning&bidid=#bidid#&userid=#userid#">
  </cfif>

 <span class="tex2">#trim(projectname)#</span></a>
...
<td width="13%" align="center"><span class="tex"><cfif paintpublishdate GT editdate>#dateformat(paintpublishdate, "mm/dd/yyyy")#<cfelse>#dateformat(editdate, "mm/dd/yyyy")#</cfif></span>&nbsp;</td>
<td width="13%" align="center"><cfif getbids.original_user is userid><a href="?action=61&pgt=#projectid#&userid=#userid#&id_mag=#id_mag#" ><span class="tex2">Delete</span></a><cfelse><span class="tex7">Delete</span></cfif>&nbsp;</td>
<td width="13%" align="center"><a href="?action=62&pgt=#projectid#&userid=#userid#&id_mag=#id_mag#" ><span class="tex2">Move</span></a>&nbsp;</td>
</tr>
</cfoutput>
<cfoutput>
...
<p></p>
<cfif getbids.recordcount is 0><table><tr><td><b><span class="tex">There are no projects listed under this folder.</span></b></td></tr></table>
</cfif> 
