...
<cfelse>
	...
	<cfquery name="qUserTags" datasource="#application.dataSource#">
		...
		values
		(<cfqueryPARAM value = "#session.auth.userid#" CFSQLType = "CF_SQL_INTEGER">, 0,0,2,2,1,'#datetimeformat(now(), "yyyy-mm-dd hh:mm:ss")#',1)	
	</cfquery>
	</cfif>
	<cfquery name="get_user1" datasource="#application.dataSource#">
		select reg_userid, name, email, emailaddress, pref.dailyUpdates, pref.getSavedSearchEmail, pref.updatedOn, pref.stages, pref.projectTypes, pref.sendInterval ,pref.budget,bid_users.userid
...
<cfif checkuser.supplierid eq 9000> 
				      
<cfoutput query="get_user1">		   	
			   						
				<div class="page-header">
				  <h3>Account Information for  <small> <b>#name#</b> last updated #datetimeformat(updatedOn,'mmm d @ hh:mm tt')#</small></h3>
				</div>
				<div class="page-header">					
						<input type="text" name="reportDate" id="reportDate" /> <button type="button" class="btn btn-primary" id="reportRunBtn">Send Email for Date</button> 
					...
					<div class="col-xs-12 col-md-6 pull-left">
						...
						<div class="col-md-12 col-xs-12 pull-left">
							...
							<div class="sectionBody">
								<div class="form-row"><div class="col-sm-12"><input type="text" name="emailaddress" value="#emailaddress#" size="50"><cfif isdefined("err")><font color="red" size="1">You have entered an invalid emailaddress.</font></cfif></div></div>
							</div>
						</div>	
						<!--- Email Preferences --->
						<div class="col-md-12 col-xs-12 pull-left">
...
<cfelse>
	<div class="h3">This feature is not available on the 360 site until we shut down the app site.</div>
</cfif>                     