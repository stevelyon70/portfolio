<cfquery name="state">
	...
	where pe.engineerID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#engineerID#" >
 ...
 <cfparam name="year_field" default="2012-2015">
	...
	<div id="responsive" class="modal fade" tabindex="-1" data-width="760" style="display: none;">
			...
			<div class="modal-body">
				<div class="row">
					...
					<cfform name="searchForm" action="#cgi.script.name#?engineer=&engineerID=#engineerID#" method="post" enctype="multipart/form-data">
	<cfoutput>
