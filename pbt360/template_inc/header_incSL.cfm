					...
					<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
						...
						<cfif isdefined("session.auth.username") and session.auth.username NEQ "" and isUserLoggedIn() >
							<ul class="dropdown-menu todo">								
								<li>
									<span class="dropdown-menu-title"> <span class="noteCount">1</span> Notifications</span>
								</li>
								<li>
									<div class="drop-down-wrapper ps-container">
										<ul>
											<li><i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Dec 22, 2017 - Searching by Coatings Type and Manufacturer have been added to the bid search form.</li>
			<!--li><i class="fa fa-info-circle wellcss pull-left text-info" aria-hidden="true"></i> Nov 28, 2017 - Looking at the map below, you can click on a state to run a search for that specific state.</li-->
