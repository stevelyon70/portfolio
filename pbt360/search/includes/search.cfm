			...
			<div class="col-md-12 col-xs-12 pull-left">
				...
				<div class="sectionBody">
					<div class="form-row"><div class="col"><label for="structures">Structures:</label>
						...
						<cfoutput>
							<option value="#valuelist(pull_agency_ind_structures.tagID)#,#valuelist(pull_agency_commercial_structures.tagID)#" >All Structures</option>
						</cfoutput>
						<cfif listlen(valuelist(pull_agency_ind_structures.tagID))>
						<cfoutput>
							<option value="#valuelist(pull_agency_ind_structures.tagID)#" >All Industrial Structures Below</option>
						</cfoutput>
						</cfif>								
					...
					<select  placeholder="Search by Scope" name="scopes" multiple="multiple" id="scopes_field" class="form-control search-select-structure">
										...
										<cfif listlen(valuelist(pull_gc_scopes.tagID))>
											<cfoutput>
												<option value="#valuelist(pull_gc_scopes.tagID)#" >All Constuction Scopes Below</option>	
											</cfoutput>	
										</cfif>
										...
										<cfif listlen(valuelist(pull_professional_services.tagID))>
					...
					<div class="form-row"><div class="col"><label for="coatingTypes">Coating Types:</label>
						...
						<cfif listlen(valuelist(pull_tag_coatingsType.tagID))>
