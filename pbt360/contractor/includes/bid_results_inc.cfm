							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="table-responsive">
										<table class="table table-striped table-bordered table-hover table-full-width" id="bidResults">
											<thead>
												<tr>
													<th>Project Name</th>
													<th>Agency</th>
											...
											<tbody>
												...
												<tr>
													<td>
													<a href="#request.rootpath#leads/?bidID=#bidID#" target="_blank">
														#projectname#
													</a></td>
												...
												<tr>
													<td colspan="6">No awards for this period.</td>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
