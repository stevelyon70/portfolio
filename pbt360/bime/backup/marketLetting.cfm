...
FROM [paintsquare].[dbo].[pbt_market_kpi_total_dollars_tagged]
 ...
 and tagid in (8,9,10,11,12,13,14,16,17,18,19,20,21,23,24,70,73,74,75,76,77,78,79)																		 
</cfquery>
...
FROM [paintsquare].[dbo].[pbt_market_kpi_total_dollars_tagged]
 where paintpublishdate >= '#url.bDate# 00:00:00' and paintpublishdate <= '#url.eDate# 23:59:59'
 and tagid in (14,21,22,72,70,15,68,25,26,69,71)																 
</cfquery>
...
<body>		 
		 ...
		 <h1>Total Ind Bids - #qIndTotalPerQuarter.total#</h1>
		 <h1>Total Ind Bids : Painting - #qIndPaintTotalPaintPerQuarter.total#</h1>
			 
		 <h1>Total Comm Bids - #qCommTotalPerQuarter.total#</h1>
		 <h1>Total Comm Bids : Painting - #qCommPaintTotalPaintPerQuarter.total#</h1>
