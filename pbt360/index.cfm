<cfinclude template="template_inc/design/wrapper_top.cfm">
					...
					<!---iframe name="BIME" height="820px" width="1024px" frameBorder="0" seamless src="https://technologypublishing.bime.io/dashboard/5B62815440C71763365E54FBAD2CE237CDAD1FB75C780879F1DC0DA1F268FDAE" ></iframe--->
					...
					<cfelse>
						<iframe frameBorder="0" seamless id="frame1" name="frame1" scroll="no" height=820px width=1500px src="https://technologypublishing.bime.io/dashboard/market-performance-total_v2?access_token=#session.auth.user_access_token###year=#session.auth.default_year#&quarter=#session.auth.default_qtr#&structuretypesordered-2373f8eae3=Bridges%2520and%2520Tunnels"></iframe>
					</cfif>
					...
					<cfelse>
						<iframe frameBorder="0" seamless id="frame1" name="frame1" scroll="no" height=820px width=1500px src="https://technologypublishing.bime.io/dashboard/market-performance-total_v2?access_token=#session.auth.user_access_token###year=#session.auth.default_year#&quarter=#session.auth.default_qtr#&structuretypesordered-2373f8eae3=Water%2520Tanks"></iframe>
					</cfif>
					...
					<cfelse>
						<iframe frameBorder="0" seamless id="frame1" name="frame1" scroll="no" height=820px width=1500px src="https://technologypublishing.bime.io/dashboard/market-performance-total_v2?access_token=#session.auth.user_access_token###year=#session.auth.default_year#&quarter=#session.auth.default_qtr#&structuretypesordered-2373f8eae3=Water%252FWastewater,Water%252FWastewater%2520Distribution%252FTransmission,Water%252FWastewater%2520Treatment"></iframe>
					</cfif>
					...
					<cfelse>
						<iframe frameBorder="0" seamless id="frame1" name="frame1" scroll="no" height=820px width=1600px  src="https://technologypublishing.bime.io/dashboard/brand-dashboard_v2?access_token=#session.auth.user_access_token#"></iframe>
					</cfif>
					...
					<cfelse>
						<iframe frameBorder="0" seamless id="frame1" name="frame1" scroll="no" height=820px width=1600px  src="https://technologypublishing.bime.io/dashboard/brand_share_v2?access_token=#session.auth.user_access_token###year=#session.auth.default_year#&quarter=#session.auth.default_qtr#"></iframe>
					</cfif>
					...
					<cfelse>
						<iframe frameBorder="0" seamless id="frame1" name="frame1" scroll="no" height=820px width=1500px  src="https://technologypublishing.bime.io/dashboard/performance_ytd_quant_v2?access_token=#session.auth.user_access_token###year=#session.auth.default_year#&quarter=#session.auth.default_qtr#"></iframe>
					</cfif>
					...
					<!-- contrak -->
						<cfinclude template="template_inc/pbtdash.cfm" />
						<!---<iframe frameBorder="0" seamless id="frame1" name="frame1" scroll="no" height=820px width=1500px  src="https://technologypublishing.bime.io/dashboard/main_dashboard_v2?access_token=#session.auth.user_access_token###year=#session.auth.default_year#&quarter=#session.auth.default_qtr#"></iframe>
