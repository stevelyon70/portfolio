...
<cfif featcodetail.emailaddress is not "">
	<cfset mail_subject="Please consider me for future job openings - sent via the Paint BidTracker Classifieds">
	<cfset mail_from="webmaster@paintbidtracker.com">
	<cfset mail_reply="#form.emailaddress#">
	<cfset mail_to="#featcodetail.emailaddress#">
					...
					<tr>
						<td width="100%">
							<p><font face="Arial, Helvetica, sans-serif" size="2">
								The following job seeker viewed your featured empolyer page in the Paint BidTracker Classifieds,
								and submitted this resum&eacute; for future consideration.
							</font></p>
						</td>
					</tr>
				</table>
				...
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="100%">
					        ...
					        <p style="margin: 6"><font face="Arial, Helvetica, sans-serif" size="2">
								As the designated contact for this employer, Paint BidTracker is happy to provide this information to you, and
						        thanks you for participating in the Paint BidTracker Classifieds.
							</font></p>
							<p style="margin: 6"><font face="Arial, Helvetica, sans-serif" size="1">
								This e-mail is sent as a service included in your featured employer program in the Paint BidTracker Classifieds. 
