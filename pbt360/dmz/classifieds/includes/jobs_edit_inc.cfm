...
<cfif isdefined("process") and process is 1 and isdefined("form.jobID") and not isdefined("noprocess")>
	<cftransaction action="begin">
		<cfset date=#createodbcdatetime(now())#>
		<!---Define form date selection--->
			<cfset temp_expiration_date = expiration_date>
			<cfif isdefined("renew")><cfif expiration_date gt date><cfset expiration_date = dateformat(expiration_date+duration, 'm/d/yyyy')><cfelse><cfset expiration_date = dateformat(date+duration, 'm/d/yyyy')></cfif></cfif>
			<cfif isdefined("deactivate")><cfset temp_expiration_date = dateformat(date-1, 'm/d/yyyy')><cfset confirm="2"></cfif>
		<!---Replace featured logo, if applicable--->
			<cfif isdefined("form.feat_logo") and form.feat_logo is not "">
				<cffile action="upload" filefield="form.feat_logo" destination="d:\wwwroot\paintsquare.com\careercenter\featuredjob_images" nameconflict="makeunique">
				<CFSET NEWFILE2 = #file.SERVERFILE#>
				<cffile action="READ" file="d:\wwwroot\paintsquare.com\careercenter\featuredjob_images\#file.SERVERFILE#" variable="#file.ClientFileExt#">
				<cfoutput>
		...
		<cfif isdefined("featbypass") or not isdefined("renew")>
...
<cfelseif isdefined("process") and process is 3>
	...
	<cflocation url="http://www.paintbidtracker.com/classifieds/includes/jobs_process.cfm?page=edit_job&jobID=#jobID#&expiration_date=#expiration_date#">
...
<cfelseif isdefined("process") and process is 4 and isdefined("jobID")>
	...
	<cftransaction>
		...
		<cfinclude template="jobs_payment_renewal_confirm_email.cfm">
	</cftransaction>
	<cflocation url="http://www.paintbidtracker.com/classifieds/?fuseaction=jobs&action=edit&confirm=1&jobID=#jobID#">
	<!---Manual continue to test e-mail--->
	<!---cfoutput><a href="#rootpath#classifieds/?fuseaction=jobs&action=edit&confirm=1&jobID=#jobID#">Continue...</a></cfoutput--->

<!---Confirm basic edits without renewal--->
<cfelseif isdefined("process") and process is 6>
	<cfset confirm=1>
...
<cfquery name="get_reguser" datasource="#the_dsn#">
	...
	where <cfif reg_userID is not "">a.reg_userID = #reg_userID#<cfelse>1=0</cfif>
</cfquery>
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<!---Require login--->
					<tr>
						<td width="100%">
							<div align="left">
								<p>To edit your job, <a href="#rootpath#register/?fuseaction=login&jobID=#jobID#&r_directory=classifieds&r_fuseaction=#fuseaction#&r_action=#action#">please sign in</a> to your free Paint BidTracker account.</p>
							</div>                              
						</td>
					</tr>
				<cfelseif isdefined("confirm") and confirm is 2>
				<!---Message to confirm deactivation--->
					<tr>
						<td width="100%">
							<div align="left">
								<p>This job has been deactivated, and will no longer appear on Paint BidTracker. The views and replies to date have not been deleted, and
								you can renew this posting by <a href="#rootpath#classifieds/?fuseaction=jobs&action=edit&jobID=#jobID#">clicking here</a>.</p>
							</div>                              
						</td>
					</tr>
				<cfelseif isdefined("confirm") and confirm is 1>
				<!---Message to thank and confirm posting--->
					<tr>
						<td width="100%">
							<div align="left">
								<p>Thanks for choosing to post your job in the Paint BidTracker classifieds. Your listing has been successfully updated, 
							...
							<div align="left">
								...
								<table border="0" cellpadding="3" cellspacing="0" width="100%">
									...
									<tr>
										...
										<cfif isdefined("renew")><cfinput type="hidden" name="renew" value="#renew#"></cfif>
										</td> 
				...
				<!---Form to display preview and continue to payment/confirmation or go back to edit--->
					<tr>
						<td width="100%">
							<div align="left">
								<cfif isdefined("renew") and price gt 0>
								<p>Below is a preview of your edited job posting. Please review carefully and click either the 'Approve and Purchase' button to continue,
								or the 'Make Changes' button to further edit your listing. Your renewal will only be confirmed once payment is completed.
								</p>
								<cfset process = 3>
								<cfset form_text = "Approve and Purchase">
								<cfelseif isdefined("renew")>
								<p>Below is a preview of your edited job posting. Please review carefully and click either the 'Approve' button to continue,
								or the 'Make Changes' button to further edit your listing. Your renewal will only be confirmed once the 'Approve' button is clicked.
								</p>
								<cfset process = 4>
								<cfset form_text = "Approve">
								<cfelse>
								<p>Below is a preview of your edited job posting. Please review carefully and click either the 'Approve' button to confirm,
								or the 'Make Changes' button to further edit your listing.
								</p>
								<cfset process = 6>
								<cfset form_text = "Approve">
								</cfif>
					...
					<tr>
						<td width="100%">
							<div align="left">
								...
								<p>To edit the details of your job posting, please make the changes below and click 'submit'.</p>
								<cfif price gt 0 and not isdefined("featbypass")>
									<p>To renew this job for another #duration# days for $#price#, check the 'Renew this job' checkbox. Payment must be done online by secure third-party payment by credit card. For other payment options, 
								...
								<cfelseif not isdefined("featbypass")>
									<p>To renew this job for another #duration# days, check the 'Renew this job' checkbox.
									</p>
								<cfelse>
						...
						<td width="100%">
							<div align="left">
								...
								<table border="0" cellpadding="3" cellspacing="0" width="100%">
									...
									<cfset lastupdate = '#get_item.lastupdated#'>
									<cfset expiration_date = '#get_item.expire#'>
									<tr>
										<td align="right" valign="top" width="25%">
											<font face="Arial" size="2"><b>Originally posted:</b></font>
										</td>
										<td valign="top" width="75%">
											#dateformat(startpost, 'mmmm d, yyyy')#
										</td>
									</tr>
									<tr>
										<td align="right" valign="top" width="25%">
											<font face="Arial" size="2"><b>Last updated:</b></font>
										</td>
										<td valign="top" width="75%">
											#dateformat(lastupdate, 'mmmm d, yyyy')#
										</td>
									</tr>
									<tr>
										<td align="right" valign="top" width="25%">
											<font face="Arial" size="2"><b>Expires On:</b></font>
										</td>
										<td valign="top" width="75%">
											#dateformat(expiration_date, 'mmmm d, yyyy')#<br>
											<cfif isdefined("renew") and renew is "on">
												<cfinput type="checkbox" name="renew" checked> Renew this job<br>
											<cfelse>
												<cfinput type="checkbox" name="renew"> Renew this job<br>
											</cfif>
											<cfinput type="checkbox" name="deactivate"> Deactivate this job<br>
										</td>
									</tr>
									<tr>
										<td align="right" valign="top" width="25%">
										...
										<td valign="top">
											<cfselect name="positionID" size="1" required message="Please select a category.">
												<cfloop query="get_category">
													<option value="#positionID#" <cfif positionID is #get_item.positionID#>selected</cfif>>#position#
												</cfloop>
											</cfselect>
										</td>
									</tr>
									...
									<tr>
										...
										<td valign="top">
											<cfselect name="confidential" size="1" required message="Please select a confidential option.">
												<option value="1" <cfif get_item.confidential is 1>selected</cfif>>Yes
												<option value="2" <cfif get_item.confidential is not 1>selected</cfif>>No
											</cfselect>
										</td>
									</tr>
									<tr>
										...
										<td valign="top">
											...
											<cfselect name="stateID" size="1">
												...
												<cfloop query="get_states">
													<option value="#stateID#" <cfif stateID is #get_item.stateID#>selected</cfif>>#stateabb#
												</cfloop>
											</cfselect>
											Country:
											<cfselect name="countryID" size="1">
												...
												<cfloop query="get_countries">
													<option value="#countryID#" <cfif countryID is #get_item.countryID#>selected</cfif>>#country#
												</cfloop>
											</cfselect>
											</font>
										</td>
									...
									<tr>
										...
										<td valign="top" align="left"> 
											<textarea id="job_description" name="description">#get_item.description#</textarea>
